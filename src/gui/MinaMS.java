 ...
 */
public class MinaMS extends javax.swing.JFrame {

    private static MinaMS instance = new MinaMS();

    /**
     * Creates new form KinMS
     */
    public static final MinaMS getInstance() {
        return instance;
    }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        try {
            ...
            Logger.getLogger(MinaMS.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MinaMS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
