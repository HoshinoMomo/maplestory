...
public enum ItemLoader {
    ...
    HIRED_MERCHANT("hiredmerchitems", "hiredmerchequipment", 5, "id", "accountid", "characterid"),
    DUEY("dueyitems", "dueyequipment", 6, "id"),
    CASHSHOP_EVAN("csitems", "csequipment", 7, "accountid"),
    MTS("mtsitems", "mtsequipment", 8, "id"),
    ...
    public Map<Integer, Pair<IItem, MapleInventoryType>> loadItems_hm(int id, int accountid) throws SQLException {
        ...
        PreparedStatement ps = InitHikariCP.execute(query.toString());
        ps.setInt(1, value);
        ps.setInt(2, id);
