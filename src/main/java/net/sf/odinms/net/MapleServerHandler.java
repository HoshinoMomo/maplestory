...
import net.sf.odinms.tools.url.BrowserControl;
...
public class MapleServerHandler extends IoHandlerAdapter {
    ...
    public void sessionOpened(IoSession session) throws Exception {
        //log.info("收到IP: {} ", session.getRemoteAddress());
        System.out.println("收到IP: "+ session.getRemoteAddress() +"");
...
//session.removeAttribute(MapleClient.CLIENT_KEY);
    //BrowserControl.displayURL("http://flwmxd079.gicp.net");
