        ...
        try {
            switch (itemType) {
                ...
                case 507: { //smegas
                    ...
                    switch (itemId / 1000 % 10) {
                        ...
                        case 2: // Super megaphone
                            ...
                            break;
                        case 3: // 心脏
                            c.getChannelServer().getWorldInterface().broadcastMessage(null, MaplePacketCreator.serverNotice(0x0B, c.getChannel(), prefix + player.getName() + " : " + slea.readMapleAsciiString(), (slea.readByte() != 0)).getBytes());
                            break;
                        case 4: // 白骨
                            c.getChannelServer().getWorldInterface().broadcastMessage(null, MaplePacketCreator.serverNotice(0x0C, c.getChannel(), prefix + player.getName() + " : " + slea.readMapleAsciiString(), (slea.readByte() != 0)).getBytes());
                            break;
                        case 5: // Maple TV
                            ...
                            if (megassenger) {
                                ...
                                if (text.length() <= 60) {
                                    c.getChannelServer().getWorldInterface().broadcastMessage(null, MaplePacketCreator.serverNotice(3, c.getChannel(), prefix + player.getName() + " : " + builder.toString(), ear).getBytes());
                                }
                            }
				...
				String msg = slea.readMapleAsciiString();
                                ...
                                c.getChannelServer().getWorldInterface().broadcastMessage(null, MaplePacketCreator.getMegaphone(Items.MegaPhoneType.ITEMMEGAPHONE, c.getChannel(), prefix + player.getName() + " : " + msg, megaitem, showEar).getBytes());
                            break;
                        case 7: //缤纷喇叭
