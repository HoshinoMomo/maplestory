...
public class ServerlistRequestHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
      ...
      //  c.getSession().write(MaplePacketCreator.getServerList(1, "小乐冒险岛2区", LoginServer.getInstance().getLoad()));
       // c.getSession().write(MaplePacketCreator.getServerList(2, "小乐冒险岛3区", LoginServer.getInstance().getLoad()));
